...
public class SwaggerConfiguration {
     ...
     */
    @Bean
    public Docket callManagerServiceApiV1() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(callManagerServiceApiInfo())
                .groupName("CallManagerService-api-1.0")
                .select()
                .paths(getPaths("v1"))
     ...
     * @return ApiInfo
     */
    private ApiInfo callManagerServiceApiInfo() {
        return new ApiInfoBuilder()
                .title("Call Manager Service")
                .version("1.0")
                .build();
    }
